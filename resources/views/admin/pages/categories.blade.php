...
@section('content')
    ...
    <div class="page">
        @if (count($categories) > 0)
            ...
            <div class="page-inner">
                ...
                <header class="page-title-bar">
                    ...
                    <!-- floating action -->
                    <button type="button" class="btn btn-success btn-floated" data-toggle="modal" data-target="#categoryAdd">
                        <span class="fa fa-plus"></span>
                    </button>
                    <!-- /floating action -->
                    <!-- title and toolbar -->
                    <div class="d-md-flex align-items-md-start">
                        <h1 class="page-title mr-sm-auto"> Categories </h1>
                        <!-- .btn-toolbar -->
                    </div>
                    <!-- /title and toolbar -->
                    @if ($errors->any())
                    ...
                    <div class="card card-fluid">
                        ...
                        <div class="card-body" style="padding-top: 2.5rem !important;">
                            ...
                            <div class="form-group">
                                <!-- .input-group -->
                                <form class="input-group input-group-alt" method="GET" action="{{ route('admin.categories.index') }}">
                                    <!-- .input-group -->
                            ...
                            <!-- /.form-group -->
                            <!-- .table-responsive -->
                            <div class="text-muted"> Showing {{ $categories->currentPage() === $categories->lastPage() ? $categories->total() : $categories->currentPage() * $categories->perPage() }} of {{ $categories->total() }} entries </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="tile tile-img mr-1">
                                                        <img class="img-fluid" src="{{ asset('admin/images/dummy/img-1.jpg') }}" alt="{{ $category->name }}">
                                                    </a>
                                                    <a href="#" data-toggle="modal" data-target="#categoryEdit" onclick="editCategory({{ $category->id }})">{{ $category->name }}</a>
                                                </td>
                                                <td class="align-middle"> {{ $category->slug }} </td>
                                                <td class="align-middle"> {{ $category->created_by ? $category->createdBy->name : '-' }} </td>
                                                <td class="align-middle"> {{ $category->updated_by ? $category->updatedBy->name : '-' }} </td>
            ...
            <div id="notfound-state" class="empty-state" style="height: 85vh;">
                ...
                <div class="empty-state-container">
                    ...
                    <div class="state-action">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#categoryAdd">Create New</button>
                    </div>
                </div>
                <!-- /.empty-state-container -->
            </div>
        ...
        <!-- Category Add Modal -->
        <div class="modal fade has-shown" id="categoryAdd" tabindex="-1" role="dialog" aria-labelledby="categoryAddLabel" aria-modal="true">
            <!-- .modal-dialog -->
                ...
                <div class="modal-content">
                    <form method="POST" action="{{ route('admin.categories.store') }}">
                        ...
                        <div class="modal-body">
                            <!-- .form-group -->
                            <div class="form-group">
                                <label for="name">Category name <span class="badge badge-danger">Required</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug" placeholder="Category slug" required readonly />
                            </div>
                            <!-- /.form-group -->
                            <!-- .form-group -->
                            <div class="form-group">
                                <label for="description">Description <span class="badge badge-secondary"><em>Optional</em></span></label>
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Category description (Optional)"></textarea>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        <!-- /.modal-body -->
        ...
        <!-- Category Add Modal -->
        <div class="modal fade has-shown" id="categoryEdit" tabindex="-1" role="dialog" aria-labelledby="categoryEditLabel" aria-modal="true">
            <!-- .modal-dialog -->
            <div class="modal-dialog modal-dialog-centered" role="document">
                <!-- .modal-content -->
                <div class="modal-content">
                    <form method="POST" action="{{ route('admin.categories.update') }}">
                        ...
                        <div class="modal-body">
                            <!-- .form-group -->
                            <div class="form-group">
                                <label for="editName">Category name <span class="badge badge-danger">Required</span></label>
                                <input type="text" class="form-control" id="editName" name="name" placeholder="Category name" required />
                            </div>
                            <!-- /.form-group -->
                            <!-- .form-group -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="editSlug" name="slug" placeholder="Category slug" required readonly />
                            </div>
                            <!-- /.form-group -->
                            <!-- .form-group -->
                            <div class="form-group">
                                <label for="editDescription">Description <span class="badge badge-secondary"><em>Optional</em></span></label>
                                <textarea class="form-control" id="editDescription" name="description" rows="3" placeholder="Category description (Optional)"></textarea>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        <!-- /.modal-body -->
